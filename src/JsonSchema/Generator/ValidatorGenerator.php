            ...
            if (\count($propertiesGuesses = $classGuess->getValidatorGuesses()) > 0) {
                ...
                $class = new Node\Stmt\Class_(
                    ...
                    [
                                ...
                                [
                                    ...
                                    'stmts' => [
                                        ...
                                        new Node\Stmt\If_(new Expr\BinaryOp\Greater(new Expr\MethodCall($violationsVariable, 'count'), new Scalar\LNumber(0)), ['stmts' => [
                                            new Node\Stmt\Throw_(new Expr\New_(new Node\Name($this->naming->getRuntimeClassFQCN($schema->getNamespace(), [], 'ValidationException')), [new Node\Arg($violationsVariable)])),
                                        ]]),
                                    ],
                                    'returnType' => 'void',
                                ]
                        ...
                        'implements' => [new Node\Name($this->naming->getRuntimeClassFQCN($schema->getNamespace(), [], 'ValidatorInterface'))],
                    ]
                );
